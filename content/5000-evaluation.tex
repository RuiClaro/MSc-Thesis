...
\begin{table}[htp]
\centering
\caption{Baseline results. Pima Indians Diabetes Dataset. ``A'' represents Accuracy, ``F'' represents F-Measure.}
...
We present the best baseline results obtained in the testing set for the Breast Cancer Wisconsin Diagnostic Dataset in Table \ref{table:baselineBCW}.

\begin{table}[htp]
\centering
\caption{Baseline results. Breast Cancer Wisconsin Diagnostic Dataset. ``A'' represents Accuracy, ``F'' represents F-Measure.}
...
\begin{table}[htp]
\centering
\caption{Baseline results. Credit Approval Dataset. ``A'' represents Accuracy, ``F'' represents F-Measure.}
...
Literature  & \begin{tabular}[c]{@{}l@{}}A: 85.5\%\tablefootnote{\url{http://docplayer.net/storage/53/32532528/1505920161/lql-Akt2A2T_EvaGfgnQww/32532528.pdf}}\\   F: -\end{tabular} & \begin{tabular}[c]{@{}l@{}}A: 86.3\%\cite{eggermont2004genetic}\\   F: -\end{tabular}  & \begin{tabular}[c]{@{}l@{}}A: 87.9\%\cite{chitra2013automatic}\\   F: -\end{tabular} & \begin{tabular}[c]{@{}l@{}}A: 86.2\%\tablefootnote{\url{http://docplayer.net/storage/53/32532528/1505920161/lql-Akt2A2T_EvaGfgnQww/32532528.pdf}}\\   F: -\end{tabular} & \begin{tabular}[c]{@{}l@{}}A: 84.8\%\cite{chitra2013automatic}\\   F: -\end{tabular} & \begin{tabular}[c]{@{}l@{}}A: 85.5\%\tablefootnote{\url{http://docplayer.net/storage/53/32532528/1505920161/lql-Akt2A2T_EvaGfgnQww/32532528.pdf}}\\   F: -\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[htp]
\centering
\caption{Baseline results. Adult Income Dataset. ``A'' represents Accuracy, ``F'' represents F-Measure.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo{José: Mudar o nome desta Section.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{José: Ver com o Prof. Miguel se mantemos tabelas aqui ou em apendice.}
...
\begin{table}[htp]
\centering
\caption{\acs{phe}+\acs{lr}. Execution time in seconds. Breast Cancer Wisconsin Diagnostic Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{phe}+\acs{svm}. Execution time in seconds. Breast Cancer Wisconsin Diagnostic Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{dt}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Pima Indians Diabetes Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{dt}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Breast Cancer Wisconsin Diagnostic Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{dt}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Credit Approval Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{dt}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Adult Income Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{k-m}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Pima Indians Diabetes Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{k-m}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Breast Cancer Wisconsin Diagnostic Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{k-m}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Credit Approval Dataset.}
...
\begin{table}[htp]
\centering
\caption{\acs{gc}+\acs{k-m}. Amount of bytes per data sample (in kB) received during runtime by the \ac{gc} evaluator. Adult Income Dataset.}
